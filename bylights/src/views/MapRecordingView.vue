<template>
    ...
    <div class = "mapLayout">
        ...
        <div class="stop-record-icon">
            <router-link to="/mapView">
                <!--binding per svg-->
                <img :src="stopRecordIcon" alt="stop record icon" class = "stop-record-style">
            </router-link>
        </div>
...
<style scoped>
    ...
    .walkingText {
        ...
        color: darkgreen;            /* Colore del testo */
...
<script>
    ...
    export default{
        ...
        setup(){
            ...
            return{lat, lng, getLocation, map, mapContainer, openMap, stopRecordIcon}
        }
    }
</script>
